...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initPluginWarning = function() {
		if (NRS.activePlugins) {
			...
			html += "Plugins are not sandboxed or restricted in any way and have full accesss to your client system including your WeOneCoin ( WOC ) passphrase.";
			html += "</p>";
			...
			html += "you can loose your WeOneCoin ( WOC )! In doubt don't run plugins with accounts ";
			html += "used to store larger amounts of WeOneCoin ( WOC ) now or in the future.";
			html += "</p>";
			html += "</div>";

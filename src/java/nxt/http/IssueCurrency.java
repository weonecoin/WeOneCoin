...
/**
 * Issue a currency on the WeOneCoin ( WOC ) blockchain
 * <p>
 * A currency is the basic block of the WeOneCoin ( WOC ) Monetary System it can be exchanged with WOC, transferred between accounts,
 ...
 * <li>minReservePerUnitNQT - the minimum WeOneCoin ( WOC ) value per unit to allow the currency to become active
 * For {@link nxt.CurrencyType#RESERVABLE} currency
 ...
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is {@link nxt.CurrencyType#CLAIMABLE} the WeOneCoin ( WOC ) used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is non {@link nxt.CurrencyType#CLAIMABLE} the WeOneCoin ( WOC ) used for

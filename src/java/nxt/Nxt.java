...
public final class Nxt {
    ...
    static {
        ...
        System.out.println("Initializing WeOneCoin ( WOC ) server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        Peers.shutdown();
        Db.shutdown();
        Logger.logShutdownMessage("WeOneCoin ( WOC ) server " + VERSION + " stopped.");
        Logger.shutdown();
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("WeOneCoin ( WOC ) server " + VERSION + " started successfully.");
                ...
                String forgerSecretPhrase = Nxt.getStringProperty("woc.forgerSecretPhrase");
